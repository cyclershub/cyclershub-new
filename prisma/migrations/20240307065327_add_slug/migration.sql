...
INSERT INTO "new_Thread" ("created_at", "description", "forum_id", "id", "title", "uid", "updated_at", "user_id") SELECT "created_at", "description", "forum_id", "id", "title", "uid", "updated_at", "user_id" FROM "Thread";
DROP TABLE "Thread";
